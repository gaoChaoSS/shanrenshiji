...
<div ng-controller="other_factorApply_Ctrl" class="d_content form_section title_section">
    ...
    <div class="overflowPC">
        <form ng-submit="firstSubmit()" ng-show="userPending.status==0 || userPending.status==0.3">
            <div class="sectionMain">
                <div ng-show="userPending.status==0" style="padding:10px 20px;">
                    注:尊敬的会员,在您提交服务站申请后,我们的工作人员会在7日内给您答复!
                </div>
            ...
            <div class="sectionMain">
                ...
                <div class="mainRow">
                    ...
                    <input type="text" class="rowInput" ng-model="userInfo.mobile"/>
                </div>
                <div class="mainRow" ng-click="goPage('/home/location/selectedArea/factorApplyArea')">
        ...
        <div ng-show="userPending.status==0.1">
            ...
            <div class="sectionMain">
                ...
                <div class="mainRow">
                    ...
                    <div class="rowInput" ng-bind="userInfo.mobile"></div>
                </div>
                <div class="mainRow">
        ...
        <div ng-show="userPending.status==1 || userPending.status==2">
            ...
            <div class="sectionMain">
                ...
                <div class="mainRow">
                    <div class="rowTitle"><span class="icon-card iconfont iconBig"></span> 发卡点名称:</div>
