package com.zq.kyb.payment.wechatSDK.scanpay.common.report.protocol;

import com.zq.kyb.payment.config.WeChatConfig;
import com.zq.kyb.payment.wechatSDK.scanpay.common.RandomStringGenerator;
import com.zq.kyb.payment.wechatSDK.scanpay.common.Signature;
...
public class ReportReqData {
     ...
     */
    public ReportReqData(String appId, String mchId, String partnerKey, String deviceInfo, String interfaceUrl, int executeTimeCost, String returnCode, String returnMsg, String resultCode, String errCode, String errCodeDes, String outTradeNo, String userIp) {
...
//        setSub_mch_id(Configure.getSubMchid());
        ...
        //根据API给的签名规则进行签名
        String sign = Signature.getSign(partnerKey, toMap());
