...
import com.zq.kyb.payment.wechatSDK.scanpay.protocol.downloadbill_protocol.DownloadBillReqData;
...
public class DownloadBillService extends BaseService {
    ...
    public DownloadBillService() throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(WeChatConfig.DOWNLOAD_BILL_API);
    }
     ...
     * @throws Exception
     */
    public String request(String sellerId, DownloadBillReqData downloadBillReqData) throws Exception {

        //--------------------------------------------------------------------
        //发送HTTPS的Post请求到API地址
        //--------------------------------------------------------------------
        String responseString = sendPost(sellerId, downloadBillReqData);
