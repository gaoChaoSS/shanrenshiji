package com.zq.kyb.payment.wechatSDK.scanpay.protocol.pay_protocol;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String appId, String mchId, String partnerKey, String authCode, String body, String attach, String outTradeNo, int totalFee, String deviceInfo, String spBillCreateIP, String timeStart, String timeExpire, String goodsTag) {
