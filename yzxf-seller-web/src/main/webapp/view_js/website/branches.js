...
(function (angular, undefined) {
    ...
    window.app.register.controller(model + '_' + entity + '_Ctrl', function ($rootScope, $scope, $location, $http, $element, $compile) {
        ...
        $scope.tempGridList = '/view/website/t_branches_grid.jsp';
        $scope.windowInfo = '/view/website/t_branchesInfo_grid.jsp';
        $scope.tempGridFilter = '/view/website/t_branches_grid_filter.jsp';
