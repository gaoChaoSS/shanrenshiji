(function (angular, undefined) {
    ...
    window.app.register.controller(model + '_' + entity + '_Ctrl', function ($rootScope, $scope, $location, $http, $element, $compile) {
        ...
        $scope.tempGridFilter = '/view/user/t_websiteNewsManage_filter.jsp';
        $scope.entityTitle = "官网新闻管理";
        $scope.tempGridList = '/view/user/t_websiteNewsManage_grid.jsp';
        $scope.contentInfo = '/view/user/t_websiteNewsManage_editor.jsp';
