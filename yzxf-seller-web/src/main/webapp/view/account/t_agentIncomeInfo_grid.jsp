...
<div class="popSection">
    ...
    <div ng-show="isSeller">
        <span>总交易额:</span>
        <span ng-show="model=='account' && entity=='sellerIncome'" ng-bind="getMoney(dataPage.$$selectedItem.orderCash)"></span>
    </div>
    <div ng-show="!isSeller">
        <span>总交易额:</span>
        <span ng-show="model=='account' && (entity=='agentIncome'||entity=='factorIncome')" ng-bind="getMoney(incomeTradeSum)"></span>
    </div>
    <div>
        <span ng-bind="entityTitle == '商家月收益结算'?'总入账:':'总收益额:'"></span>
        <span ng-bind="getMoney(dataPage.$$selectedItem.incomeAccount)"></span>
    </div>
    <div ng-show="entity=='agentIncome'">
        <span>慈善金:</span>
        <span ng-bind="getMoney(dataPage.$$selectedItem.incomeAccount*0.01)"></span>
    </div>
</div>
    ...
    <div style="width:100%;padding:0">
        <div class="sectionTable">
            <div>
                ...
                <div style="width:10%">收益入账</div>
                <div style="width:15%">结算时间</div>
            </div>
            <div ng-repeat="order in orderList2" class="trBk">
                ...
                <div style="width:10%;color: green;" ng-bind="getMoney(order.orderCash)"></div>
                <div style="width:15%" ng-bind="showYFullTime(order.endTime)"></div>
            </div>
        </div>
...
<div class="sectionPage" ng-class="winCheck?'bottom0':''" ng-hide="isNullPage2" style="position: absolute;left: 0;bottom: -40px;width: 100%;margin: 0;">
    <div class="btn3" ng-click="pageNext(-1)" ng-show="pageIndex2!=1">上一页</div>
    ...
    <div class="btn3" ng-click="pageNext(1)" ng-show="pageIndex2!=totalPage2">下一页</div>
    <div class="pageGo">
