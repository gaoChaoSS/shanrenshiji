...
<div class="popSection flex2" ng-show="userInfo.loginName!=null && userInfo.loginName!=''">
    ...
    <div ng-show="entityTitle == '代理商管理'">
        <span>密码:</span>
        <button class="btn1" ng-click="resetUserPwd()">重置</button>
    </div>
</div>
<div class="popSection flex2" ng-show="entityTitle=='待复审'">
...
<div class="popSection flex2">
    ...
    <div style="width:100%;white-space: inherit">
        <span>当前地址:</span>
        <span ng-bind="userInfo.address"></span>
    </div>
</div>
<div class="popSection flex2">
    ...
    <div>
        <span>银行总行:</span>
        <span ng-bind="userInfo.bankType"></span>
    </div>
    <div>
        <span>开户行:</span>
    ...
    <div>
        <span>开户行城市:</span>
        <span ng-bind="userInfo.bankProvince+' '+userInfo.bankCity"></span>
    </div>
    <div>
        <span>银行账号:</span>
...
<div class="popSectionPage" ng-class="winCheck?'bottom0':''" ng-show="pendingBtnCheck">
...
<div class="sectionHintBk" ng-show="checkBtn[3]">
    <div class="sectionHint">
        ...
        <div class="flex1">
            <button class="btn1 bkColorRed1" ng-click="checkBtnFun(3)">确定</button>
        </div>
    </div>
</div>
