...
<%!  public void createTradeExcelTable(HttpServletRequest request,HttpServletResponse response) throws Exception {
    Message message = Message.newReqMessage("1:GET@/order/OrderInfo/getAccidentLog");
...
//    System.out.print("--------------"+message.getContent()+"--------------");
    ...
    //文件名
    String fileName = dateNowStr+"-会员意外险投保明细.xls";
    //文件保存路径
...
//             第四步，创建单元格，并设置值
        ...
        row.createCell((short) 2).setCellValue(getNullObject(item,"area"));
