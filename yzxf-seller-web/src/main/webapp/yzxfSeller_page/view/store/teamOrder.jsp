...
<div ng-controller="store_teamOrder_Ctrl" class="d_content title_section form_section my_team_Ctrl">
    <div class="title">
        <span class="icon-left-1 iconfont titleBack" ng-click="goPage('/store/store')"></span>
        我的红包
        <span class="titleManage black textSize15 grayaaa" ng-click="goPage('/store/team')">成员</span>
    </div>
    <div style="text-align: center">该红包金额已自动存入账户余额中</div>
    <div class="overflowPC">
        <div style="padding-top:10px;background:#fff;position:relative">
            ...
            <div class="flex3">
                ...
                <div class="numCon">
                    ...
                    <div class="notHigh textCenter" ng-bind="'今日奖励收益 ('+isNullZero(countItem.dayNum)+'笔)'"></div>
                </div>
            </div>
        </div>
        ...
        <div ng-repeat="item in team" class="itemCon flex5" style="align-items: center;position:relative">
            ...
            <div>
                <div>
                    ...
                    <span class="notHigh" ng-if="!isEmpty2(item.realName)" ng-bind="'( '+item.realName+' )'"></span>
