...
<div ng-controller="store_payForgotPassword_Ctrl" class="form_section d_content title_section">
    <div class="title">
        <span class="icon-left-1 iconfont titleBack" ng-click="goBack()"></span>
        密码找回
    </div>
    <form ng-submit="payForgotPwd()">
        <div class="mainRowTitle notHigh">短信验证</div>
        <div class="sectionMain sectionMainNotMargin">
            <div class="mainRow">
                <div class="rowTitle">手机号:</div>
                <input type="text" class="rowInput rowInputShort" placeholder="请输入当前登录用户手机号码" ng-model="phoneNumber" ng-change="phoneCheck();submitBtn()" />
            </div>
            <div class="mainRow">
            ...
            <div class="mainRow">
                ...
                <span class="mainRowRight errorRed mainRowRightErrorText" ng-show="firstPwd==''?false:pwdLengthError">6位数字</span>
        ...
        <div style="text-align: center;padding: 5px 0;background-color: #FF9900" class="submitBtn" ng-disabled="pCheck" ng-click="getPhoneCheckCode()" ng-bind="codeDiv?countdown+'s后再获取验证码':'点击获取验证码'"></div>
        ...
        <button type="submit" class="submitBtn" ng-disabled="check">完成</button>
    </form>
</div>