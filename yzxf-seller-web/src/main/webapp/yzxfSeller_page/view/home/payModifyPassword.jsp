...
<div ng-controller="home_payModifyPassword_Ctrl" class="form_section d_content title_section">
    <div class="title">
    ...
    <form ng-show="userType=='seller'" ng-submit="modifySellerPayPwd()">
    ...
    <form ng-show="userType=='factor'" ng-submit="modifyFactorPayPwd()">
        <div class="sectionMain">
            <div class="mainRow">
                <div class="rowTitle">旧密码:</div>
                <input type="{{showPassword?'text':'password'}}" class="rowInput" ng-model="oldPwd" ng-change="nextBtn()" placeholder="请输入原来的支付密码"/>
