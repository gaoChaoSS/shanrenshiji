...
<head>
    <%
        pageContext.setAttribute("serverVersion", "0.0787");
    ...
    <%--<link rel="stylesheet" type="text/css" media="(min-width: 100px) and (max-width: 750px)"--%>
...
<%--首页的底部tab--%>
<div id="bottomTabList" class="tab-bottom tab" ng-if="isIndex||isPc()">
...
<%--登录页面--%>
<div class="topPageCon loginCon " ng-if="notLogin" ng-include="loginTemp" style="position: absolute"></div>
...
<script type="text/javascript" src="/yzxfSeller_page/yzxfSeller_app.js?_v=${serverVersion}"></script>
<%--各种提示声音--%>
<audio id="notifi" style="display: none;">
    <%--<source type="audio/ogg" src="/yzxfSeller_page/img/notifi.ogg"/>--%>
    <%--<source type="audio/mpeg" src="/yzxfSeller_page/img/notifi.mp3"/>--%>
</audio>
