...
public class Base64 {
	...
	/**
	 * Encodes or decodes two files from the command line; <strong>feel free to delete this method (in fact you probably should) if you're embedding this code into a larger program.</strong>
	 */
	public final static void main(String[] args) {
		...
		System.out.println(new String(Base64.decode("MQ==")));
	...
	private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
		...
		// Example: DkLE
			...
			try {
				...
				Logger.getLogger(Base64.class.getName()).info("" + source[srcOffset] + ": " + (DECODABET[source[srcOffset]]));
				Logger.getLogger(Base64.class.getName()).info("" + source[srcOffset + 1] + ": " + (DECODABET[source[srcOffset + 1]]));
				Logger.getLogger(Base64.class.getName()).info("" + source[srcOffset + 2] + ": " + (DECODABET[source[srcOffset + 2]]));
				Logger.getLogger(Base64.class.getName()).info("" + source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
				return -1;
			} // end catch
		}
	} // end decodeToBytes
